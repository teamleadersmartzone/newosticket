...
define('SECRET_SALT','El7Hgfpl0H-6O5nNU70VzrDjm.OBe1WF');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','pankaj_kumar036@yahoo.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost');
define('DBNAME','smartzo1_osticket');
define('DBUSER','smartzo1_os');
